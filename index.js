...
function swapMinMax(array) {
  ...
  [array[max], array[minIndex]] = [array[min], array[maxIndex]];
...
function replaceNumbers(arr) {
  ...
  for (const index in arr) {
    if (arr[index] > 10) {
      arr2[index] = "Greater than 10";
    } else if (arr[index] <= 10) {
      arr2[index] = "Less than or equal to 10";
    }
  }
  return arr2;
}
